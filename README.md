...
During the game the user must decifer the correct number and letter to be placed in the correct box
...
# Wireframes
![Silly-Duko wireframes](assets/css/images/wireframe-1.png)


 [Top](<#contents>)

# Game Structure
For the game I decide to create a board with boh numbers and letters. The board is made up of the traditional 81 squares
